...
optim.fn <- function(optimLandcovers, landcoverData, gridSquare, shuffleCodes, 
  ...
  # source functions
  source("cluster/code/prepare_landscape.R")
  source("cluster/code/nsga2r_edited/nsga2R_edited.R")
  ...
  saveRDS(list("optim"=optim, "optimLandcovers"=optimLandcovers,"shuffleCodes"=shuffleCodes, "radius"=radius, "objectives"=objectives), file=paste0("cluster/results/optimisations/",outputName))
