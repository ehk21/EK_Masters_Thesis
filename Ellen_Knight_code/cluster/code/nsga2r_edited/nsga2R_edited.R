...
nsga2R.edited <-
  function(fn, varNo, objDim, lowerBounds=rep(-Inf,varNo), upperBounds=rep(Inf,varNo),
    ...
    # Source functions
    source("cluster/code/fitness/fitness_crop_poll.R")
    source("cluster/code/nsga2r_edited/boundedPolyMutation_edited.R")
    source("cluster/code/nsga2r_edited/boundedSBXover_edited.R")
