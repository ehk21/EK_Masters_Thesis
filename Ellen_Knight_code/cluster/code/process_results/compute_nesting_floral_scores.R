...
compute.nesting.floral.scores <- function(landscape, wedRaster, arRaster, objectives) {
      ...
      #Set working dir
      dir = "~/Imperial College/research_project-main/research_project-main/Ellen_Knight_code/"
      ...
      source(paste(dir,"cluster/code/fitness/computeFloralNesting_specifycolumnletter.R",sep=""))
      source(paste(dir,"cluster/code/fitness/getsteadystatepop.R",sep=""))
      source(paste(dir,"cluster/code/fitness/runpoll_3seasons.R",sep=""))
      source(paste(dir,"cluster/code/fitness/kerncalc.R",sep=""))
      source(paste(dir,"cluster/code/fitness/latfordisp.R",sep=""))
      source(paste(dir,"cluster/code/fitness/growth.func.R",sep=""))
      ...
      wed = wedRaster
      wlf = readRDS("cluster/data/WLF2km")
      ar = arRaster
