...
fitness<- function(x, objectives, optimLandcovers, optimFields, optimRaster, 
  ...
  fol_ip = "cluster/data/fitness/input_parameters"
  
  #Set grid square folder name
  fol_gs = "cluster/data/SK86"
  ...
  source("cluster/code/fitness/computeFloralNesting_specifycolumnletter.R")
  source("cluster/code/fitness/getsteadystatepop.R")
  source("cluster/code/fitness/runpoll_3seasons.R")
  source("cluster/code/fitness/kerncalc.R")
  source("cluster/code/fitness/latfordisp.R")
  source("cluster/code/fitness/growth.func.R")
  source("cluster/code/fitness/new_landscape.R")
  source("cluster/code/fitness/getcropyieldsandincome_edited.R")
  ...
  for (s in 1:length(objectives)){
    ...
    if (grepl("Farmer",obj)==TRUE) { 
      visitationtoyield <- read.csv("cluster/data/fitness/input_parameters/VisitationYieldRelationship.csv")
      yieldfactors_temporal <- read.csv("cluster/data/fitness/input_parameters/NationalCropProductivityperYear.csv")
